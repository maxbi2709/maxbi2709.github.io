...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Harry Rauramo"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Harry Rauramo</td></tr>
					<tr><td>Profession</td><td>Full Stack Developer</td></tr>
					<tr><td>Sex</td><td>Male</td></tr>
					<tr><td>Resume</td><td><a href="/resume/resume.pdf" download>Download Resume</a></td></tr>
					<tr><td>Portfolio</td><td><a href="https://maxbi2709.github.io/portfolio2020/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:maxbi2709@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="https://t.me/maxbi2709"><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/maxbi2709" target="_blank"><i class="fab fa-github"></i></a>
              <a href="https://x.com/happydreamer927" target="_blank"><i class="fab fa-twitter"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Harry Rauramo Facial Recognition">
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://www.arter.fi/">Arter Oy</a></td><td>Finland</td><td>2017</td><td><a href="#" onclick="modal(event)" data-title="Arter Oy">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://oivan.com/">Oivan</a></td><td>Finland</td><td>2018</td><td><a href="#" onclick="modal(event)" data-title="Oivan">Full Report</a></td></tr>
					<tr><td>Working from home</td><td>Remote</td><td>2022~</td><td><a href="#" onclick="modal(event)" data-title="Working from home">Full Report</a></td></tr>
					<tr><td>Remote</td><td>Remote</td><td>~2025</td><td><a href="#" onclick="modal(event)" data-title="Remote">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>Go</td></tr>
				...
				<tr><td>C++</td><td>Web3</td></tr>
				<tr><td>SQL</td><td>etc...</td></tr>
			</tbody>
		</table>`,
  },
  {
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Harry " -lastName "Rauramo"',
        typing: true,
      },
      {
        text: "loading...",
...
var missions = {
  "Remote": `
		<h3>Role</h3>
		<p>Game Engine Dev / Tech Lead</p>

		<h3>Directives</h3>
		<p>▪ Built a full-stack casino platform with live games, slots, and wallet integrations. Implemented secure payment systems, multi-currency support, and provably fair
smart contracts.</p>
		<p>▪ Developed a 3-reel slot game with animations and validation. Integrated RNG logic in python and deployed on Node.js backend with Phaser.js for frontend visuals.</p>
		<p>▪Contributed to a live sports betting platform, building real-time APIs and Integrating multiple payment gate ways..</p>
  ...
  Oivan: `
    ...
    <p>▪ Built real-time notification and alert service which enables real-time notifications and alerts to keep users informed about their financial activities, including transaction updates, account balances, payment reminders, and
security alerts./p>
    ...
    <p>▪ Built and deployed end-to-end web applications using React, Node.js, Express, and MongoDB, serving thousands of active users.</p>
    ...
    <p>▪ Automated testing and deployment pipelines with Jenkins/GitLab CI + Docker + Kubernetes, ensuring reliable releases</p>
    <p>▪ Built real-time notification and alert service which enables real-time notifications and alerts to keep users informed about their financial activities, including transaction updates, account balances, payment reminders, and
security alerts</p>
	`,
  "Arter Oy": `
		...
		<h3>Directives</h3>
    <p>▪ Built and maintained responsive web applications using React, JavaScript (ES6+), HTML5, and CSS3, ensuring cross-browser and mobile compatibility</p>
    <p>▪ Collaborated with designers and product managers to translate UI/UX wireframes into high-quality, interactive user experiences..</p>
    <p>▪ Improved page performance and load times by 30% through code optimization, lazy loading, and image compression</p>
    ...
    <p>▪ Participated in Agile ceremonies, conducted peer code reviews, and ensured best practices in clean, scalable front-end architecture</p>
